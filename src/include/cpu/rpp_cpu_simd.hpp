...
inline void rpp_saturate48_0to1(__m256 *p)
{
    // Saturate values to 0 - 1 range
...
inline void rpp_saturate24_0to1(__m256 *p)
{
    // Saturate values to 0 - 1 range
    p[0] = _mm256_min_ps(_mm256_max_ps(p[0], avx_p0), avx_p1);
    p[1] = _mm256_min_ps(_mm256_max_ps(p[1], avx_p0), avx_p1);
...
inline void rpp_saturate16_0to1(__m256 *p)
{
    // Saturate values to 0 - 1 range
    p[0] = _mm256_min_ps(_mm256_max_ps(p[0], avx_p0), avx_p1);
    p[1] = _mm256_min_ps(_mm256_max_ps(p[1], avx_p0), avx_p1);
...
inline void rpp_saturate8_0to1(__m256 *p)
{
    // Saturate values to 0 - 1 range
    p[0] = _mm256_min_ps(_mm256_max_ps(p[0], avx_p0), avx_p1);
}
