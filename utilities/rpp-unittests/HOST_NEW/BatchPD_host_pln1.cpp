...
int main(int argc, char **argv)
{
    ...
    case 82:
    {
        ...
        if (ip_bitDepth == 0)
            ...
            missingFuncFlag = 1; //rppi_ricap_f16_pln1_batchPD_host(inputf16, srcSize, maxSize, outputf16, permutedArray1, permutedArray2, permutedArray3, permutedArray4, cropRegion1, cropRegion2, cropRegion3, cropRegion4, outputFormatToggle, noOfImages, handle);
        else if (ip_bitDepth == 2)
            ...
            missingFuncFlag = 1; //rppi_ricap_i8_pln1_batchPD_host(inputi8, srcSize, maxSize, outputi8, permutedArray1, permutedArray2, permutedArray3, permutedArray4, cropRegion1, cropRegion2, cropRegion3, cropRegion4, outputFormatToggle, noOfImages, handle);
        else if (ip_bitDepth == 6)
            missingFuncFlag = 1;
        else
            missingFuncFlag = 1;
